...
extension String {
    private static let zhHansTranslations: [String: String] = [
        "about": "关于",
        "add": "添加",
        "add_repo": "添加软件源",
    ...
    private static var prefersSimplifiedChinese: Bool {
    ...
    var localized: String {
        if Self.prefersSimplifiedChinese, let translation = Self.zhHansTranslations[self] {
            return translation
        }
